    ...
    <header class="sticky top-0 z-40 border-b border-navy/10 bg-white/75 backdrop-blur">
      <div class="mx-auto flex w-full max-w-6xl items-center gap-4 px-5 py-3">
        <a href="#top" class="flex items-center gap-3">
          <div class="h-10 w-10 rounded-2xl bg-gradient-to-br from-ocean to-[#006C9F] shadow-soft"></div>
          <div class="leading-tight">
            <div class="font-display text-[14px] font-extrabold">{{ (content.siteName || "Balincah Trip Manado").split(" ")[0] }} Trip</div>
            <div class="text-[12px] font-semibold text-black/60">Manado</div>
          </div>
        </a>
